...
const raw_metricas = [
  ...
  {"Pais": "PER", "Trimestre": "Q3", "Mes": "Julio", "Total_Errores": 402, "Headcount": 7678}
];
...
const raw_detalles = [
  ...
  {"Pais": "PER", "Trimestre": "Q3", "Mes": "Julio", "Capacidad": "1. Operations", "Subcapacidad": " 1.2 Training Management", "Cantidad": 6, "Crudo Mes": ""}
];
...
const raw_textos = [
  ...
  {"Pais": "COL", "Trimestre": "Q3", "Titulo": "Jul - Ago - Sep", "Analisis_HTML": "<p>Para julio, se presentó un incremento del indicador de errores de nómina con un 8,64% equivalente a 6.595 personas afectadas. Este incremento estuvo explicado por 6.208 personas afectadas debido a descuentos ocasionados por fallas en el SP de la BD de apoyos nómina en el proceso de Data Calculation, convirtiéndose en el principal driver del deterioro del indicador en el periodo.</p>"},
  ...
  {"Pais": "PER", "Trimestre": "Q3", "Titulo": "Jul - Ago - Sep", "Analisis_HTML": "<p>Para julio, se presentó un incremento del indicador de errores de nómina con un 5,21% equivalente a 400 personas afectadas. Este incremento estuvo explicado por 334 personas afectadas, esto derivado de una novedad en el cálculo de DRA por un día feriado que cayó en domingo y que no estaba contemplado dentro de la definición del cálculo.</p>"}
];
